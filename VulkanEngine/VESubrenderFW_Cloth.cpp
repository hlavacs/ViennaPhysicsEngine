...
// by Felix Neumann
// Modification of VESubrenderFW_D.cpp by Helmut Hlavacs, University of Vienna
...
namespace ve
{
	...
	/// </summary>
	void VESubrenderFW_Cloth::initSubrenderer()
	{
		VESubrenderFW::initSubrenderer();

		vh::vhRenderCreateDescriptorSetLayout(m_renderer.getDevice(), { m_resourceArrayLength },
	...
	void VESubrenderFW_Cloth::setDynamicPipelineState(VkCommandBuffer commandBuffer,
		uint32_t numPass)
	{
		if (numPass == 0)
		{
	...
	void VESubrenderFW_Cloth::addEntity(VEEntity* pEntity)
	{
