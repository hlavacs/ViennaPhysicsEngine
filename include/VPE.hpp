...
namespace vpe {
	...
	//Had compiler issues, i needed to remove constexpr
	static glmvec3 toPhysics(glmvec3 vec) { return C * vec; }
	static glmmat3 toPhysics(glmmat3 mat) { return CTrans * mat * C; }
	static glmmat4 toPhysics(glmmat4 mat) { return glmmat4{CTrans} * mat * glmmat4{C}; }
	static glmvec3 fromPhysics(glmvec3 vec) { return CTrans * vec; }
	static glmmat3 fromPhysics(glmmat3 mat) { return C * mat * CTrans; }
	static glmmat4 fromPhysics(glmmat4 mat) { return glmmat4{C} * mat * glmmat4{CTrans};}
	...
	public:
		...
		//--------------------------------------------------------------------------------------------------
		//adamr64 - Project Truck Polytopes


		/// <summary>
		/// This is the template of a cylinder object for the wheels. 
		/// I created a cube with Blender with the exact same dimensions as the truck body.
		/// It contains the basic geometric properties:
		/// Vertices, edges, and faces. We use a left-handed coordinate system. 
		/// Edges can have signs, meaning their vectors are multiplied with this factor (1 or -1).
		/// </summary>
		inline static Polytope g_cylinder{
	{ { 0.500000000000000_real, 0.000000000000000_real, -0.150000000000000_real }, { 0.500000000000000_real, 0.000000000000000_real, 0.150000000000000_real }, { 0.498929461619302_real, 0.032701564615072_real, -0.150000000000000_real }, { 0.498929461619302_real, 0.032701564615072_real, 0.150000000000000_real }, { 0.495722430686905_real, 0.065263096110026_real, -0.150000000000000_real }, { 0.495722430686905_real, 0.065263096110026_real, 0.150000000000000_real }, { 0.490392640201615_real, 0.097545161008064_real, -0.150000000000000_real }, { 0.490392640201615_real, 0.097545161008064_real, 0.150000000000000_real }, { 0.482962913144534_real, 0.129409522551260_real, -0.150000000000000_real }, { 0.482962913144534_real, 0.129409522551260_real, 0.150000000000000_real }, { 0.473465064747553_real, 0.160719732651581_real, -0.150000000000000_real }, { 0.473465064747553_real, 0.160719732651581_real, 0.150000000000000_real }, { 0.461939766255643_real, 0.191341716182545_real, -0.150000000000000_real }, { 0.461939766255643_real, 0.191341716182545_real, 0.150000000000000_real }, { 0.448436370766344_real, 0.221144345109501_real, -0.150000000000000_real }, { 0.448436370766344_real, 0.221144345109501_real, 0.150000000000000_real }, { 0.433012701892219_real, 0.250000000000000_real, -0.150000000000000_real }, { 0.433012701892219_real, 0.250000000000000_real, 0.150000000000000_real }, { 0.415734806151273_real, 0.277785116509801_real, -0.150000000000000_real }, { 0.415734806151273_real, 0.277785116509801_real, 0.150000000000000_real }, { 0.396676670145618_real, 0.304380714504360_real, -0.150000000000000_real }, { 0.396676670145618_real, 0.304380714504360_real, 0.150000000000000_real }, { 0.375919903739489_real, 0.329672907550034_real, -0.150000000000000_real }, { 0.375919903739489_real, 0.329672907550034_real, 0.150000000000000_real }, { 0.353553390593274_real, 0.353553390593274_real, -0.150000000000000_real }, { 0.353553390593274_real, 0.353553390593274_real, 0.150000000000000_real }, { 0.329672907550034_real, 0.375919903739489_real, -0.150000000000000_real }, { 0.329672907550034_real, 0.375919903739489_real, 0.150000000000000_real }, { 0.304380714504360_real, 0.396676670145618_real, -0.150000000000000_real }, { 0.304380714504360_real, 0.396676670145618_real, 0.150000000000000_real }, { 0.277785116509801_real, 0.415734806151273_real, -0.150000000000000_real }, { 0.277785116509801_real, 0.415734806151273_real, 0.150000000000000_real }, { 0.250000000000000_real, 0.433012701892219_real, -0.150000000000000_real }, { 0.250000000000000_real, 0.433012701892219_real, 0.150000000000000_real }, { 0.221144345109501_real, 0.448436370766344_real, -0.150000000000000_real }, { 0.221144345109501_real, 0.448436370766344_real, 0.150000000000000_real }, { 0.191341716182545_real, 0.461939766255643_real, -0.150000000000000_real }, { 0.191341716182545_real, 0.461939766255643_real, 0.150000000000000_real }, { 0.160719732651581_real, 0.473465064747553_real, -0.150000000000000_real }, { 0.160719732651581_real, 0.473465064747553_real, 0.150000000000000_real }, { 0.129409522551260_real, 0.482962913144534_real, -0.150000000000000_real }, { 0.129409522551260_real, 0.482962913144534_real, 0.150000000000000_real }, { 0.097545161008064_real, 0.490392640201615_real, -0.150000000000000_real }, { 0.097545161008064_real, 0.490392640201615_real, 0.150000000000000_real }, { 0.065263096110026_real, 0.495722430686905_real, -0.150000000000000_real }, { 0.065263096110026_real, 0.495722430686905_real, 0.150000000000000_real }, { 0.032701564615072_real, 0.498929461619302_real, -0.150000000000000_real }, { 0.032701564615072_real, 0.498929461619302_real, 0.150000000000000_real }, { 0.000000000000000_real, 0.500000000000000_real, -0.150000000000000_real }, { 0.000000000000000_real, 0.500000000000000_real, 0.150000000000000_real }, { -0.032701564615072_real, 0.498929461619302_real, -0.150000000000000_real }, { -0.032701564615072_real, 0.498929461619302_real, 0.150000000000000_real }, { -0.065263096110026_real, 0.495722430686905_real, -0.150000000000000_real }, { -0.065263096110026_real, 0.495722430686905_real, 0.150000000000000_real }, { -0.097545161008064_real, 0.490392640201615_real, -0.150000000000000_real }, { -0.097545161008064_real, 0.490392640201615_real, 0.150000000000000_real }, { -0.129409522551260_real, 0.482962913144534_real, -0.150000000000000_real }, { -0.129409522551260_real, 0.482962913144534_real, 0.150000000000000_real }, { -0.160719732651581_real, 0.473465064747553_real, -0.150000000000000_real }, { -0.160719732651581_real, 0.473465064747553_real, 0.150000000000000_real }, { -0.191341716182545_real, 0.461939766255643_real, -0.150000000000000_real }, { -0.191341716182545_real, 0.461939766255643_real, 0.150000000000000_real }, { -0.221144345109501_real, 0.448436370766344_real, -0.150000000000000_real }, { -0.221144345109501_real, 0.448436370766344_real, 0.150000000000000_real }, { -0.250000000000000_real, 0.433012701892219_real, -0.150000000000000_real }, { -0.250000000000000_real, 0.433012701892219_real, 0.150000000000000_real }, { -0.277785116509801_real, 0.415734806151273_real, -0.150000000000000_real }, { -0.277785116509801_real, 0.415734806151273_real, 0.150000000000000_real }, { -0.304380714504360_real, 0.396676670145618_real, -0.150000000000000_real }, { -0.304380714504360_real, 0.396676670145618_real, 0.150000000000000_real }, { -0.329672907550034_real, 0.375919903739489_real, -0.150000000000000_real }, { -0.329672907550034_real, 0.375919903739489_real, 0.150000000000000_real }, { -0.353553390593274_real, 0.353553390593274_real, -0.150000000000000_real }, { -0.353553390593274_real, 0.353553390593274_real, 0.150000000000000_real }, { -0.375919903739489_real, 0.329672907550034_real, -0.150000000000000_real }, { -0.375919903739489_real, 0.329672907550034_real, 0.150000000000000_real }, { -0.396676670145618_real, 0.304380714504360_real, -0.150000000000000_real }, { -0.396676670145618_real, 0.304380714504360_real, 0.150000000000000_real }, { -0.415734806151273_real, 0.277785116509801_real, -0.150000000000000_real }, { -0.415734806151273_real, 0.277785116509801_real, 0.150000000000000_real }, { -0.433012701892219_real, 0.250000000000000_real, -0.150000000000000_real }, { -0.433012701892219_real, 0.250000000000000_real, 0.150000000000000_real }, { -0.448436370766344_real, 0.221144345109501_real, -0.150000000000000_real }, { -0.448436370766344_real, 0.221144345109501_real, 0.150000000000000_real }, { -0.461939766255643_real, 0.191341716182545_real, -0.150000000000000_real }, { -0.461939766255643_real, 0.191341716182545_real, 0.150000000000000_real }, { -0.473465064747553_real, 0.160719732651581_real, -0.150000000000000_real }, { -0.473465064747553_real, 0.160719732651581_real, 0.150000000000000_real }, { -0.482962913144534_real, 0.129409522551261_real, -0.150000000000000_real }, { -0.482962913144534_real, 0.129409522551261_real, 0.150000000000000_real }, { -0.490392640201615_real, 0.097545161008064_real, -0.150000000000000_real }, { -0.490392640201615_real, 0.097545161008064_real, 0.150000000000000_real }, { -0.495722430686905_real, 0.065263096110026_real, -0.150000000000000_real }, { -0.495722430686905_real, 0.065263096110026_real, 0.150000000000000_real }, { -0.498929461619302_real, 0.032701564615072_real, -0.150000000000000_real }, { -0.498929461619302_real, 0.032701564615072_real, 0.150000000000000_real }, { -0.500000000000000_real, 0.000000000000000_real, -0.150000000000000_real }, { -0.500000000000000_real, 0.000000000000000_real, 0.150000000000000_real }, { -0.498929461619302_real, -0.032701564615071_real, -0.150000000000000_real }, { -0.498929461619302_real, -0.032701564615071_real, 0.150000000000000_real }, { -0.495722430686905_real, -0.065263096110026_real, -0.150000000000000_real }, { -0.495722430686905_real, -0.065263096110026_real, 0.150000000000000_real }, { -0.490392640201615_real, -0.097545161008064_real, -0.150000000000000_real }, { -0.490392640201615_real, -0.097545161008064_real, 0.150000000000000_real }, { -0.482962913144534_real, -0.129409522551260_real, -0.150000000000000_real }, { -0.482962913144534_real, -0.129409522551260_real, 0.150000000000000_real }, { -0.473465064747553_real, -0.160719732651581_real, -0.150000000000000_real }, { -0.473465064747553_real, -0.160719732651581_real, 0.150000000000000_real }, { -0.461939766255643_real, -0.191341716182545_real, -0.150000000000000_real }, { -0.461939766255643_real, -0.191341716182545_real, 0.150000000000000_real }, { -0.448436370766344_real, -0.221144345109501_real, -0.150000000000000_real }, { -0.448436370766344_real, -0.221144345109501_real, 0.150000000000000_real }, { -0.433012701892219_real, -0.250000000000000_real, -0.150000000000000_real }, { -0.433012701892219_real, -0.250000000000000_real, 0.150000000000000_real }, { -0.415734806151273_real, -0.277785116509801_real, -0.150000000000000_real }, { -0.415734806151273_real, -0.277785116509801_real, 0.150000000000000_real }, { -0.396676670145618_real, -0.304380714504360_real, -0.150000000000000_real }, { -0.396676670145618_real, -0.304380714504360_real, 0.150000000000000_real }, { -0.375919903739489_real, -0.329672907550034_real, -0.150000000000000_real }, { -0.375919903739489_real, -0.329672907550034_real, 0.150000000000000_real }, { -0.353553390593274_real, -0.353553390593274_real, -0.150000000000000_real }, { -0.353553390593274_real, -0.353553390593274_real, 0.150000000000000_real }, { -0.329672907550035_real, -0.375919903739489_real, -0.150000000000000_real }, { -0.329672907550035_real, -0.375919903739489_real, 0.150000000000000_real }, { -0.304380714504360_real, -0.396676670145617_real, -0.150000000000000_real }, { -0.304380714504360_real, -0.396676670145617_real, 0.150000000000000_real }, { -0.277785116509801_real, -0.415734806151273_real, -0.150000000000000_real }, { -0.277785116509801_real, -0.415734806151273_real, 0.150000000000000_real }, { -0.250000000000000_real, -0.433012701892219_real, -0.150000000000000_real }, { -0.250000000000000_real, -0.433012701892219_real, 0.150000000000000_real }, { -0.221144345109501_real, -0.448436370766344_real, -0.150000000000000_real }, { -0.221144345109501_real, -0.448436370766344_real, 0.150000000000000_real }, { -0.191341716182545_real, -0.461939766255643_real, -0.150000000000000_real }, { -0.191341716182545_real, -0.461939766255643_real, 0.150000000000000_real }, { -0.160719732651581_real, -0.473465064747553_real, -0.150000000000000_real }, { -0.160719732651581_real, -0.473465064747553_real, 0.150000000000000_real }, { -0.129409522551260_real, -0.482962913144534_real, -0.150000000000000_real }, { -0.129409522551260_real, -0.482962913144534_real, 0.150000000000000_real }, { -0.097545161008064_real, -0.490392640201615_real, -0.150000000000000_real }, { -0.097545161008064_real, -0.490392640201615_real, 0.150000000000000_real }, { -0.065263096110026_real, -0.495722430686905_real, -0.150000000000000_real }, { -0.065263096110026_real, -0.495722430686905_real, 0.150000000000000_real }, { -0.032701564615071_real, -0.498929461619302_real, -0.150000000000000_real }, { -0.032701564615071_real, -0.498929461619302_real, 0.150000000000000_real }, { -0.000000000000000_real, -0.500000000000000_real, -0.150000000000000_real }, { -0.000000000000000_real, -0.500000000000000_real, 0.150000000000000_real }, { 0.032701564615071_real, -0.498929461619302_real, -0.150000000000000_real }, { 0.032701564615071_real, -0.498929461619302_real, 0.150000000000000_real }, { 0.065263096110026_real, -0.495722430686905_real, -0.150000000000000_real }, { 0.065263096110026_real, -0.495722430686905_real, 0.150000000000000_real }, { 0.097545161008064_real, -0.490392640201615_real, -0.150000000000000_real }, { 0.097545161008064_real, -0.490392640201615_real, 0.150000000000000_real }, { 0.129409522551260_real, -0.482962913144534_real, -0.150000000000000_real }, { 0.129409522551260_real, -0.482962913144534_real, 0.150000000000000_real }, { 0.160719732651581_real, -0.473465064747553_real, -0.150000000000000_real }, { 0.160719732651581_real, -0.473465064747553_real, 0.150000000000000_real }, { 0.191341716182545_real, -0.461939766255643_real, -0.150000000000000_real }, { 0.191341716182545_real, -0.461939766255643_real, 0.150000000000000_real }, { 0.221144345109501_real, -0.448436370766344_real, -0.150000000000000_real }, { 0.221144345109501_real, -0.448436370766344_real, 0.150000000000000_real }, { 0.250000000000000_real, -0.433012701892219_real, -0.150000000000000_real }, { 0.250000000000000_real, -0.433012701892219_real, 0.150000000000000_real }, { 0.277785116509801_real, -0.415734806151273_real, -0.150000000000000_real }, { 0.277785116509801_real, -0.415734806151273_real, 0.150000000000000_real }, { 0.304380714504360_real, -0.396676670145618_real, -0.150000000000000_real }, { 0.304380714504360_real, -0.396676670145618_real, 0.150000000000000_real }, { 0.329672907550035_real, -0.375919903739489_real, -0.150000000000000_real }, { 0.329672907550035_real, -0.375919903739489_real, 0.150000000000000_real }, { 0.353553390593274_real, -0.353553390593274_real, -0.150000000000000_real }, { 0.353553390593274_real, -0.353553390593274_real, 0.150000000000000_real }, { 0.375919903739489_real, -0.329672907550034_real, -0.150000000000000_real }, { 0.375919903739489_real, -0.329672907550034_real, 0.150000000000000_real }, { 0.396676670145617_real, -0.304380714504360_real, -0.150000000000000_real }, { 0.396676670145617_real, -0.304380714504360_real, 0.150000000000000_real }, { 0.415734806151272_real, -0.277785116509801_real, -0.150000000000000_real }, { 0.415734806151272_real, -0.277785116509801_real, 0.150000000000000_real }, { 0.433012701892219_real, -0.250000000000000_real, -0.150000000000000_real }, { 0.433012701892219_real, -0.250000000000000_real, 0.150000000000000_real }, { 0.448436370766344_real, -0.221144345109501_real, -0.150000000000000_real }, { 0.448436370766344_real, -0.221144345109501_real, 0.150000000000000_real }, { 0.461939766255643_real, -0.191341716182545_real, -0.150000000000000_real }, { 0.461939766255643_real, -0.191341716182545_real, 0.150000000000000_real }, { 0.473465064747553_real, -0.160719732651581_real, -0.150000000000000_real }, { 0.473465064747553_real, -0.160719732651581_real, 0.150000000000000_real }, { 0.482962913144534_real, -0.129409522551261_real, -0.150000000000000_real }, { 0.482962913144534_real, -0.129409522551261_real, 0.150000000000000_real }, { 0.490392640201615_real, -0.097545161008064_real, -0.150000000000000_real }, { 0.490392640201615_real, -0.097545161008064_real, 0.150000000000000_real }, { 0.495722430686905_real, -0.065263096110026_real, -0.150000000000000_real }, { 0.495722430686905_real, -0.065263096110026_real, 0.150000000000000_real }, { 0.498929461619302_real, -0.032701564615071_real, -0.150000000000000_real }, { 0.498929461619302_real, -0.032701564615071_real, 0.150000000000000_real } },
	{ {0,1}, {0,2}, {1,3}, {2,3}, {2,4}, {3,5}, {4,5}, {4,6}, {5,7}, {6,7}, {6,8}, {7,9}, {8,9}, {8,10}, {9,11}, {10,11}, {10,12}, {11,13}, {12,13}, {12,14}, {13,15}, {14,15}, {14,16}, {15,17}, {16,17}, {16,18}, {17,19}, {18,19}, {18,20}, {19,21}, {20,21}, {20,22}, {21,23}, {22,23}, {22,24}, {23,25}, {24,25}, {24,26}, {25,27}, {26,27}, {26,28}, {27,29}, {28,29}, {28,30}, {29,31}, {30,31}, {30,32}, {31,33}, {32,33}, {32,34}, {33,35}, {34,35}, {34,36}, {35,37}, {36,37}, {36,38}, {37,39}, {38,39}, {38,40}, {39,41}, {40,41}, {40,42}, {41,43}, {42,43}, {42,44}, {43,45}, {44,45}, {44,46}, {45,47}, {46,47}, {46,48}, {47,49}, {48,49}, {48,50}, {49,51}, {50,51}, {50,52}, {51,53}, {52,53}, {52,54}, {53,55}, {54,55}, {54,56}, {55,57}, {56,57}, {56,58}, {57,59}, {58,59}, {58,60}, {59,61}, {60,61}, {60,62}, {61,63}, {62,63}, {62,64}, {63,65}, {64,65}, {64,66}, {65,67}, {66,67}, {66,68}, {67,69}, {68,69}, {68,70}, {69,71}, {70,71}, {70,72}, {71,73}, {72,73}, {72,74}, {73,75}, {74,75}, {74,76}, {75,77}, {76,77}, {76,78}, {77,79}, {78,79}, {78,80}, {79,81}, {80,81}, {80,82}, {81,83}, {82,83}, {82,84}, {83,85}, {84,85}, {84,86}, {85,87}, {86,87}, {86,88}, {87,89}, {88,89}, {88,90}, {89,91}, {90,91}, {90,92}, {91,93}, {92,93}, {92,94}, {93,95}, {94,95}, {94,96}, {95,97}, {96,97}, {96,98}, {97,99}, {98,99}, {98,100}, {99,101}, {100,101}, {100,102}, {101,103}, {102,103}, {102,104}, {103,105}, {104,105}, {104,106}, {105,107}, {106,107}, {106,108}, {107,109}, {108,109}, {108,110}, {109,111}, {110,111}, {110,112}, {111,113}, {112,113}, {112,114}, {113,115}, {114,115}, {114,116}, {115,117}, {116,117}, {116,118}, {117,119}, {118,119}, {118,120}, {119,121}, {120,121}, {120,122}, {121,123}, {122,123}, {122,124}, {123,125}, {124,125}, {124,126}, {125,127}, {126,127}, {126,128}, {127,129}, {128,129}, {128,130}, {129,131}, {130,131}, {130,132}, {131,133}, {132,133}, {132,134}, {133,135}, {134,135}, {134,136}, {135,137}, {136,137}, {136,138}, {137,139}, {138,139}, {138,140}, {139,141}, {140,141}, {140,142}, {141,143}, {142,143}, {142,144}, {143,145}, {144,145}, {144,146}, {145,147}, {146,147}, {146,148}, {147,149}, {148,149}, {148,150}, {149,151}, {150,151}, {150,152}, {151,153}, {152,153}, {152,154}, {153,155}, {154,155}, {154,156}, {155,157}, {156,157}, {156,158}, {157,159}, {158,159}, {158,160}, {159,161}, {160,161}, {160,162}, {161,163}, {162,163}, {162,164}, {163,165}, {164,165}, {164,166}, {165,167}, {166,167}, {166,168}, {167,169}, {168,169}, {168,170}, {169,171}, {170,171}, {170,172}, {171,173}, {172,173}, {172,174}, {173,175}, {174,175}, {174,176}, {175,177}, {176,177}, {176,178}, {177,179}, {178,179}, {178,180}, {179,181}, {180,181}, {180,182}, {181,183}, {182,183}, {182,184}, {183,185}, {184,185}, {184,186}, {185,187}, {186,187}, {186,188}, {187,189}, {188,189}, {188,190}, {189,191}, {190,191}, {190,0}, {191,1} },
	{
		{ { 0, 1 }, { 2, 1 }, { 3, 1 }, { 1, 1 } },
		{ { 2, 1 }, { 4, 1 }, { 5, 1 }, { 3, 1 } },
		{ { 4, 1 }, { 6, 1 }, { 7, 1 }, { 5, 1 } },
		...
		{ { 94, 1 }, { 96, 1 }, { 97, 1 }, { 95, 1 } },
		{ { 96, 1 }, { 98, 1 }, { 99, 1 }, { 97, 1 } },
		{ { 98, 1 }, { 100, 1 }, { 101, 1 }, { 99, 1 } },
		{ { 100, 1 }, { 102, 1 }, { 103, 1 }, { 101, 1 } },
		{ { 102, 1 }, { 104, 1 }, { 105, 1 }, { 103, 1 } },
		{ { 104, 1 }, { 106, 1 }, { 107, 1 }, { 105, 1 } },
		{ { 106, 1 }, { 108, 1 }, { 109, 1 }, { 107, 1 } },
		{ { 108, 1 }, { 110, 1 }, { 111, 1 }, { 109, 1 } },
		{ { 110, 1 }, { 112, 1 }, { 113, 1 }, { 111, 1 } },
		{ { 112, 1 }, { 114, 1 }, { 115, 1 }, { 113, 1 } },
		{ { 114, 1 }, { 116, 1 }, { 117, 1 }, { 115, 1 } },
		{ { 116, 1 }, { 118, 1 }, { 119, 1 }, { 117, 1 } },
		{ { 118, 1 }, { 120, 1 }, { 121, 1 }, { 119, 1 } },
		{ { 120, 1 }, { 122, 1 }, { 123, 1 }, { 121, 1 } },
		{ { 122, 1 }, { 124, 1 }, { 125, 1 }, { 123, 1 } },
		{ { 124, 1 }, { 126, 1 }, { 127, 1 }, { 125, 1 } },
		{ { 126, 1 }, { 128, 1 }, { 129, 1 }, { 127, 1 } },
		{ { 128, 1 }, { 130, 1 }, { 131, 1 }, { 129, 1 } },
		{ { 130, 1 }, { 132, 1 }, { 133, 1 }, { 131, 1 } },
		{ { 132, 1 }, { 134, 1 }, { 135, 1 }, { 133, 1 } },
		{ { 134, 1 }, { 136, 1 }, { 137, 1 }, { 135, 1 } },
		{ { 136, 1 }, { 138, 1 }, { 139, 1 }, { 137, 1 } },
		{ { 138, 1 }, { 140, 1 }, { 141, 1 }, { 139, 1 } },
		{ { 140, 1 }, { 142, 1 }, { 143, 1 }, { 141, 1 } },
		{ { 142, 1 }, { 144, 1 }, { 145, 1 }, { 143, 1 } },
		{ { 144, 1 }, { 146, 1 }, { 147, 1 }, { 145, 1 } },
		{ { 146, 1 }, { 148, 1 }, { 149, 1 }, { 147, 1 } },
		{ { 148, 1 }, { 150, 1 }, { 151, 1 }, { 149, 1 } },
		{ { 150, 1 }, { 152, 1 }, { 153, 1 }, { 151, 1 } },
		{ { 152, 1 }, { 154, 1 }, { 155, 1 }, { 153, 1 } },
		{ { 154, 1 }, { 156, 1 }, { 157, 1 }, { 155, 1 } },
		{ { 156, 1 }, { 158, 1 }, { 159, 1 }, { 157, 1 } },
		{ { 158, 1 }, { 160, 1 }, { 161, 1 }, { 159, 1 } },
		{ { 160, 1 }, { 162, 1 }, { 163, 1 }, { 161, 1 } },
		{ { 162, 1 }, { 164, 1 }, { 165, 1 }, { 163, 1 } },
		{ { 164, 1 }, { 166, 1 }, { 167, 1 }, { 165, 1 } },
		{ { 166, 1 }, { 168, 1 }, { 169, 1 }, { 167, 1 } },
		{ { 168, 1 }, { 170, 1 }, { 171, 1 }, { 169, 1 } },
		{ { 170, 1 }, { 172, 1 }, { 173, 1 }, { 171, 1 } },
		{ { 172, 1 }, { 174, 1 }, { 175, 1 }, { 173, 1 } },
		{ { 174, 1 }, { 176, 1 }, { 177, 1 }, { 175, 1 } },
		{ { 176, 1 }, { 178, 1 }, { 179, 1 }, { 177, 1 } },
		{ { 178, 1 }, { 180, 1 }, { 181, 1 }, { 179, 1 } },
		{ { 180, 1 }, { 182, 1 }, { 183, 1 }, { 181, 1 } },
		{ { 182, 1 }, { 184, 1 }, { 185, 1 }, { 183, 1 } },
		{ { 184, 1 }, { 186, 1 }, { 187, 1 }, { 185, 1 } },
		{ { 186, 1 }, { 188, 1 }, { 189, 1 }, { 187, 1 } },
		{ { 188, 1 }, { 190, 1 }, { 191, 1 }, { 189, 1 } },
		{ { 190, 1 }, { 0, 1 }, { 1, 1 }, { 191, 1 } },
		{ { 0, 1 }, { 2, 1 }, { 4, 1 }, { 6, 1 }, { 8, 1 }, { 10, 1 }, { 12, 1 }, { 14, 1 }, { 16, 1 }, { 18, 1 }, { 20, 1 }, { 22, 1 }, { 24, 1 }, { 26, 1 }, { 28, 1 }, { 30, 1 }, { 32, 1 }, { 34, 1 }, { 36, 1 }, { 38, 1 }, { 40, 1 }, { 42, 1 }, { 44, 1 }, { 46, 1 }, { 48, 1 }, { 50, 1 }, { 52, 1 }, { 54, 1 }, { 56, 1 }, { 58, 1 }, { 60, 1 }, { 62, 1 }, { 64, 1 }, { 66, 1 }, { 68, 1 }, { 70, 1 }, { 72, 1 }, { 74, 1 }, { 76, 1 }, { 78, 1 }, { 80, 1 }, { 82, 1 }, { 84, 1 }, { 86, 1 }, { 88, 1 }, { 90, 1 }, { 92, 1 }, { 94, 1 }, { 96, 1 }, { 98, 1 }, { 100, 1 }, { 102, 1 }, { 104, 1 }, { 106, 1 }, { 108, 1 }, { 110, 1 }, { 112, 1 }, { 114, 1 }, { 116, 1 }, { 118, 1 }, { 120, 1 }, { 122, 1 }, { 124, 1 }, { 126, 1 }, { 128, 1 }, { 130, 1 }, { 132, 1 }, { 134, 1 }, { 136, 1 }, { 138, 1 }, { 140, 1 }, { 142, 1 }, { 144, 1 }, { 146, 1 }, { 148, 1 }, { 150, 1 }, { 152, 1 }, { 154, 1 }, { 156, 1 }, { 158, 1 }, { 160, 1 }, { 162, 1 }, { 164, 1 }, { 166, 1 }, { 168, 1 }, { 170, 1 }, { 172, 1 }, { 174, 1 }, { 176, 1 }, { 178, 1 }, { 180, 1 }, { 182, 1 }, { 184, 1 }, { 186, 1 }, { 188, 1 }, { 190, 1 } },
		{ { 1, 1 }, { 3, 1 }, { 5, 1 }, { 7, 1 }, { 9, 1 }, { 11, 1 }, { 13, 1 }, { 15, 1 }, { 17, 1 }, { 19, 1 }, { 21, 1 }, { 23, 1 }, { 25, 1 }, { 27, 1 }, { 29, 1 }, { 31, 1 }, { 33, 1 }, { 35, 1 }, { 37, 1 }, { 39, 1 }, { 41, 1 }, { 43, 1 }, { 45, 1 }, { 47, 1 }, { 49, 1 }, { 51, 1 }, { 53, 1 }, { 55, 1 }, { 57, 1 }, { 59, 1 }, { 61, 1 }, { 63, 1 }, { 65, 1 }, { 67, 1 }, { 69, 1 }, { 71, 1 }, { 73, 1 }, { 75, 1 }, { 77, 1 }, { 79, 1 }, { 81, 1 }, { 83, 1 }, { 85, 1 }, { 87, 1 }, { 89, 1 }, { 91, 1 }, { 93, 1 }, { 95, 1 }, { 97, 1 }, { 99, 1 }, { 101, 1 }, { 103, 1 }, { 105, 1 }, { 107, 1 }, { 109, 1 }, { 111, 1 }, { 113, 1 }, { 115, 1 }, { 117, 1 }, { 119, 1 }, { 121, 1 }, { 123, 1 }, { 125, 1 }, { 127, 1 }, { 129, 1 }, { 131, 1 }, { 133, 1 }, { 135, 1 }, { 137, 1 }, { 139, 1 }, { 141, 1 }, { 143, 1 }, { 145, 1 }, { 147, 1 }, { 149, 1 }, { 151, 1 }, { 153, 1 }, { 155, 1 }, { 157, 1 }, { 159, 1 }, { 161, 1 }, { 163, 1 }, { 165, 1 }, { 167, 1 }, { 169, 1 }, { 171, 1 }, { 173, 1 }, { 175, 1 }, { 177, 1 }, { 179, 1 }, { 181, 1 }, { 183, 1 }, { 185, 1 }, { 187, 1 }, { 189, 1 }, { 191, 1 } }
	},
	[](real mass, glmvec3& s) {
		return mass * glmmat3{
			{ s.y * s.y + s.z * s.z, 0, 0 },
		...
		inline static Polytope g_sphere{
			{ { -0.288675134594813_real, 0.288675134594813_real, -0.288675134594813_real }, { -0.114707866935281_real, 0.344123600805843_real, -0.344123600805843_real }, { -0.150755672288882_real, 0.452267016866645_real, -0.150755672288882_real }, { -0.344123600805843_real, 0.344123600805843_real, -0.114707866935281_real }, { 0.114707866935281_real, 0.344123600805843_real, -0.344123600805843_real }, { 0.150755672288882_real, 0.452267016866645_real, -0.150755672288882_real }, { 0.288675134594813_real, 0.288675134594813_real, -0.288675134594813_real }, { 0.344123600805843_real, 0.344123600805843_real, -0.114707866935281_real }, { -0.150755672288882_real, 0.452267016866645_real, 0.150755672288882_real }, { -0.344123600805843_real, 0.344123600805843_real, 0.114707866935281_real }, { 0.150755672288882_real, 0.452267016866645_real, 0.150755672288882_real }, { 0.344123600805843_real, 0.344123600805843_real, 0.114707866935281_real }, { -0.114707866935281_real, 0.344123600805843_real, 0.344123600805843_real }, { -0.288675134594813_real, 0.288675134594813_real, 0.288675134594813_real }, { 0.114707866935281_real, 0.344123600805843_real, 0.344123600805843_real }, { 0.288675134594813_real, 0.288675134594813_real, 0.288675134594813_real }, { -0.288675134594813_real, -0.288675134594813_real, 0.288675134594813_real }, { -0.114707866935281_real, -0.344123600805843_real, 0.344123600805843_real }, { -0.150755672288882_real, -0.452267016866645_real, 0.150755672288882_real }, { -0.344123600805843_real, -0.344123600805843_real, 0.114707866935281_real }, { 0.114707866935281_real, -0.344123600805843_real, 0.344123600805843_real }, { 0.150755672288882_real, -0.452267016866645_real, 0.150755672288882_real }, { 0.288675134594813_real, -0.288675134594813_real, 0.288675134594813_real }, { 0.344123600805843_real, -0.344123600805843_real, 0.114707866935281_real }, { -0.150755672288882_real, -0.452267016866645_real, -0.150755672288882_real }, { -0.344123600805843_real, -0.344123600805843_real, -0.114707866935281_real }, { 0.150755672288882_real, -0.452267016866645_real, -0.150755672288882_real }, { 0.344123600805843_real, -0.344123600805843_real, -0.114707866935281_real }, { -0.114707866935281_real, -0.344123600805843_real, -0.344123600805843_real }, { -0.288675134594813_real, -0.288675134594813_real, -0.288675134594813_real }, { 0.114707866935281_real, -0.344123600805843_real, -0.344123600805843_real }, { 0.288675134594813_real, -0.288675134594813_real, -0.288675134594813_real }, { -0.452267016866645_real, -0.150755672288882_real, -0.150755672288882_real }, { -0.344123600805843_real, -0.114707866935281_real, -0.344123600805843_real }, { -0.452267016866645_real, -0.150755672288882_real, 0.150755672288882_real }, { -0.344123600805843_real, -0.114707866935281_real, 0.344123600805843_real }, { -0.452267016866645_real, 0.150755672288882_real, -0.150755672288882_real }, { -0.344123600805843_real, 0.114707866935281_real, -0.344123600805843_real }, { -0.452267016866645_real, 0.150755672288882_real, 0.150755672288882_real }, { -0.344123600805843_real, 0.114707866935281_real, 0.344123600805843_real }, { 0.452267016866645_real, -0.150755672288882_real, 0.150755672288882_real }, { 0.344123600805843_real, -0.114707866935281_real, 0.344123600805843_real }, { 0.452267016866645_real, -0.150755672288882_real, -0.150755672288882_real }, { 0.344123600805843_real, -0.114707866935281_real, -0.344123600805843_real }, { 0.452267016866645_real, 0.150755672288882_real, 0.150755672288882_real }, { 0.344123600805843_real, 0.114707866935281_real, 0.344123600805843_real }, { 0.452267016866645_real, 0.150755672288882_real, -0.150755672288882_real }, { 0.344123600805843_real, 0.114707866935281_real, -0.344123600805843_real }, { -0.150755672288882_real, -0.150755672288882_real, 0.452267016866645_real }, { 0.150755672288882_real, -0.150755672288882_real, 0.452267016866645_real }, { -0.150755672288882_real, 0.150755672288882_real, 0.452267016866645_real }, { 0.150755672288882_real, 0.150755672288882_real, 0.452267016866645_real }, { 0.150755672288882_real, -0.150755672288882_real, -0.452267016866645_real }, { -0.150755672288882_real, -0.150755672288882_real, -0.452267016866645_real }, { 0.150755672288882_real, 0.150755672288882_real, -0.452267016866645_real }, { -0.150755672288882_real, 0.150755672288882_real, -0.452267016866645_real } },
			{ {0,1}, {1,2}, {2,3}, {0,3}, {1,4}, {4,5}, {2,5}, {4,6}, {6,7}, {5,7}, {2,8}, {8,9}, {3,9}, {5,10}, {8,10}, {7,11}, {10,11}, {8,12}, {12,13}, {9,13}, {10,14}, {12,14}, {11,15}, {14,15}, {16,17}, {17,18}, {18,19}, {16,19}, {17,20}, {20,21}, {18,21}, {20,22}, {22,23}, {21,23}, {18,24}, {24,25}, {19,25}, {21,26}, {24,26}, {23,27}, {26,27}, {24,28}, {28,29}, {25,29}, {26,30}, {28,30}, {27,31}, {30,31}, {25,32}, {32,33}, {29,33}, {19,34}, {32,34}, {16,35}, {34,35}, {32,36}, {36,37}, {33,37}, {34,38}, {36,38}, {35,39}, {38,39}, {3,36}, {0,37}, {9,38}, {13,39}, {23,40}, {40,41}, {22,41}, {27,42}, {40,42}, {31,43}, {42,43}, {40,44}, {44,45}, {41,45}, {42,46}, {44,46}, {43,47}, {46,47}, {11,44}, {15,45}, {7,46}, {6,47}, {17,48}, {35,48}, {20,49}, {48,49}, {41,49}, {48,50}, {39,50}, {49,51}, {50,51}, {45,51}, {12,50}, {14,51}, {30,52}, {43,52}, {28,53}, {52,53}, {33,53}, {52,54}, {47,54}, {53,55}, {54,55}, {37,55}, {4,54}, {1,55} },
			{
				{ { 0, 1 }, { 1, 1 }, { 2, 1 }, { 3, 1 } },
				{ { 1, 1 }, { 4, 1 }, { 5, 1 }, { 2, 1 } },
				{ { 4, 1 }, { 6, 1 }, { 7, 1 }, { 5, 1 } },
			...
			[](real mass, glmvec3& s) {
						...
						real radius = s.x; // Assuming bounding box x is radius
						real I = (2.0_real / 5.0_real) * mass * (radius * radius);
						return glmmat3{ {I, 0, 0}, {0, I, 0}, {0, 0, I} };
					}
		};
		...
		///<summary>
		///A joint suitable for vehicle wheels. 
		///- Rotational: Acts like a Hinge (rotates around axle).
		///- Translational: Acts like a Slider with a Spring (moves up/down along suspension axis).
		///</summary>
		class AdvancedWheelSuspensionJoint : public Constraint {
		...
		private:
			...
			//Spring Parameters
			real m_suspension_stiffness = 50.0_real;      //Spring Force constant (k)
			real m_suspension_damping = 2.0_real;         //Damping constant (c)

			//Constraint Parameters
			real m_bias_factor_rot = 0.5_real;            //Baumgarte for rotation
			real m_bias_factor_limit = 0.5_real;          //Baumgarte for angular limits
			real m_bias_factor_lin_constraint = 0.5_real; //Baumgarte for the locked linear axes

			//Geometry
			glmvec3 m_anchor_body1;                       //Anchor on Chassis
			glmvec3 m_anchor_body2;                       //Anchor on Wheel

			//We need two main axes defined in Body1's space:
			glmvec3 m_axis_hinge_body1;                   //The Axle (Rotation happens here, translation locked)
			glmvec3 m_axis_susp_body1;                    //The Suspension (Translation allowed here with spring)

			//Body 2 only needs the hinge axis for the rotation constraint alignment
			glmvec3 m_axis_hinge_body2;

			//Rotational Limits & Motor
			bool m_limit_active = false;
			real m_limit_max = -pi2;
			real m_limit_min = pi2;
			glmquat m_init_orientation_inv;
			...
			glmvec3 m_r1{ 0.0_real };					//Vector center->anchor (Body1)
			glmvec3 m_r2{ 0.0_real };					//Vector center->anchor (Body2)
			glmvec3 m_axle_w{ 0.0_real };				//Hinge axis in World
			glmvec3 m_susp_w{ 0.0_real };				//Suspension axis in World
			glmvec3 m_perp_w{ 0.0_real };				//3rd axis (Forward) in World

			//Linear Constraints (Locking Axle and Forward/Perp motion)
			glmvec2 m_linear_offset{ 0.0_real };		//Positional error for locked axes
			glmvec2 m_linear_bias{ 0.0_real };			//Baumgarte bias for locked axes
			glmmat2 m_inv_mass_linear{ 0.0_real };		//2x2 Mass matrix for locked axes
			glmvec3 m_lin_J1_axle, m_lin_J2_axle;		//Jacobian parts for Axle axis
			glmvec3 m_lin_J1_perp, m_lin_J2_perp;		//Jacobian parts for Perp axis

			//Spring Data
			real m_spring_displacement = 0.0_real;		//How compressed/extended is the spring?
			...
			//Steering Parameters
			bool m_steering_active = false;
			real m_steering_target_angle = 0.0_real;	//Target angle

			WheelSide m_side = WheelSide::NONE;
			WheelPosition m_position = WheelPosition::NONE;


			///<summary>
			///Helper to compute rotational mass for limits/motor
			///</summary>
			real getMotorAndLimitMass() const {
				real mass = glm::dot(m_axle_w * m_body1->m_inertia_invW, m_axle_w) + glm::dot(m_axle_w * m_body2->m_inertia_invW, m_axle_w);
				return mass < Constraint::epsilon ? 0.0_real : 1.0_real / mass;
			}
		...
		public:
			...
			///Constructor
			///</summary>
			AdvancedWheelSuspensionJoint(std::shared_ptr<Body> body1, std::shared_ptr<Body> body2, glmvec3 anchor, glmvec3 hingeAxis, glmvec3 suspensionAxis)
				: Constraint(body1, body2)
			{
				m_anchor_body1 = m_body1->m_model_inv * glmvec4(anchor, 1.0_real);
				m_anchor_body2 = m_body2->m_model_inv * glmvec4(anchor, 1.0_real);

				glmvec3 hingeNorm = glm::normalize(hingeAxis);
				glmvec3 suspensionNorm = glm::normalize(suspensionAxis);

				m_axis_hinge_body1 = glm::normalize(m_body1->m_model_inv * glmvec4(hingeNorm, 0.0_real));
				m_axis_susp_body1 = glm::normalize(m_body1->m_model_inv * glmvec4(suspensionNorm, 0.0_real));

				m_axis_hinge_body2 = glm::normalize(m_body2->m_model_inv * glmvec4(hingeNorm, 0.0_real));
			}

			~AdvancedWheelSuspensionJoint() {}
			...
			///</summary>
			///<param name="motor_speed">The angular speed in radians/sec that the motor should maintain</param>
			///<param name="max_force">The maximum torque in newton meters that can be applied per iteration.</param>
			void enableMotor(real motor_speed, real max_force) {
				assert(max_force > 0.0_real);
				m_fmotor = motor_speed;
				m_fmotor_max = max_force;
			...
			///<summary>
			///Enables the steering control for the wheel (only applies to front wheels).
			///</summary>
			void enableSteering(real target_angle) {
				m_steering_target_angle = target_angle;
				m_steering_active = true;
			}

			///<summary>
			///Disables the steering control for the wheel.
			///</summary>
			void disableSteering() {
				m_steering_active = false;
				m_steering_target_angle = 0.0_real;
			}

			///<summary>
			///Sets the side of the vehicle this wheel is on. (Left/Right)
			///</summary>
			void setWheelSide(WheelSide side) {
				m_side = side;
			}

			///<summary>
			///Gets the side of the vehicle this wheel is on. (Left/Right)
			///</summary>
			WheelSide getWheelSide() const {
				return m_side;
			}

			///<summary>
			///Sets the position of the vehicle this wheel is on. (Front/Rear)
			///</summary>
			void setWheelPosition(WheelPosition position) {
				m_position = position;
			}

			///<summary>
			///Gets the Position of the vehicle this wheel is on. (Front/Rear)
			///</summary>
			WheelPosition getWheelPosition() const {
				return m_position;
			}
			///<summary>
			///Sets the spring parameters for the suspension
			///</summary>
			///<param name="stiffness"></param>
			///<param name="damping"></param>
			void setSpringParameters(real stiffness, real damping) {
				m_suspension_stiffness = stiffness;
				m_suspension_damping = damping;
			}

			///<summary>
			///Gets the spring parameters for the suspension
			///</summary>
			std::pair<real, real> getSpringParameters() const {
				return std::make_pair(m_suspension_stiffness, m_suspension_damping);
			}

			///<summary>
			///Sets up the constraint for the current timestep
			///</summary>
			///<param name="dt"></param>
			void setUp(real dt) override {
				...
				//Move bodies back to world space
				glmvec3 anchor1_w = m_body1->m_model * glmvec4(m_anchor_body1, 1.0_real);
				glmvec3 anchor2_w = m_body2->m_model * glmvec4(m_anchor_body2, 1.0_real);

				m_r1 = anchor1_w - m_body1->m_positionW;
				m_r2 = anchor2_w - m_body2->m_positionW;

				//Calculating the Distance Vector
				//This is the vector connecting the Chassis anchor to the Wheel anchor
				glmvec3 diff = anchor2_w - anchor1_w;

				//Transform local axes to world space, defines the coordinate system for the suspension as it sits in the world right now
				//Relative Directions -> World directions

				//The "Axle" direction defined locally (Left/Right)
				m_axle_w = glm::normalize(m_body1->m_model * glmvec4(m_axis_hinge_body1, 0.0_real));
				//The "Suspension" direction (Up/Down)
				m_susp_w = glm::normalize(m_body1->m_model * glmvec4(m_axis_susp_body1, 0.0_real));

				//The Cross Product of two vectors produces a third vector that is perpendicular (90°) to both (Forward/Backward)
				//We will lock movement along this m_perp_w axis
				m_perp_w = glm::normalize(glm::cross(m_susp_w, m_axle_w));
				
				//----------------------------------------------------------------------
				//2. Linear Constraints (Locking Axle & Perp Axes)
				//----------------------------------------------------------------------

				//Measuring the Displacement
				real dist_axle = glm::dot(diff, m_axle_w); //meters, the wheel shifted left/right relative to the car
				real dist_perp = glm::dot(diff, m_perp_w); //meters, the wheel shifted forward/backward relative to the car
				//distance along the suspension axis is allowed

				m_linear_offset = glmvec2(dist_axle, dist_perp);	//2 dimensional vector measuring the displacement along the 2 axis
				
				//The Baumgarte Stabilizer (The "Bias")
				m_linear_bias = (m_bias_factor_lin_constraint / dt) * m_linear_offset;

				//This prevents the wheel from snapping back very fast during a rollover causing an explosion in physics
				real max_linear_correction = 5.0_real; //Limit correction to 5m/s
				m_linear_bias.x = std::clamp(m_linear_bias.x, -max_linear_correction, max_linear_correction);
				m_linear_bias.y = std::clamp(m_linear_bias.y, -max_linear_correction, max_linear_correction);

				//Calculating the Jacobians, define how a change in velocity affects the constraint
				m_lin_J1_axle = glm::cross(m_r1, m_axle_w);
				m_lin_J2_axle = glm::cross(m_r2, m_axle_w);
				m_lin_J1_perp = glm::cross(m_r1, m_perp_w);
				m_lin_J2_perp = glm::cross(m_r2, m_perp_w);

				//Resistance along the Axle axis
				//Combined linear inverse mass + rotational resistance on Body 1 + rotational resistance on Body 2
				real k_00 = m_body1->m_mass_inv + m_body2->m_mass_inv +
					glm::dot(m_lin_J1_axle * m_body1->m_inertia_invW, m_lin_J1_axle) +
					glm::dot(m_lin_J2_axle * m_body2->m_inertia_invW, m_lin_J2_axle);

				//Resistance along the Perp (Forward) axis
				real k_11 = m_body1->m_mass_inv + m_body2->m_mass_inv +
					glm::dot(m_lin_J1_perp * m_body1->m_inertia_invW, m_lin_J1_perp) +
					glm::dot(m_lin_J2_perp * m_body2->m_inertia_invW, m_lin_J2_perp);

				//Measures how much pushing on the axle causes a reaction on the perp axis.
				real k_01 = glm::dot(m_lin_J1_axle * m_body1->m_inertia_invW, m_lin_J1_perp) +
					glm::dot(m_lin_J2_axle * m_body2->m_inertia_invW, m_lin_J2_perp);

				glmmat2 massMat(k_00, k_01, k_01, k_11);
				m_inv_mass_linear = glm::determinant(massMat) < Constraint::epsilon ? glmmat2(0.0_real) : glm::inverse(massMat);

				//----------------------------------------------------------------------
				//3. Spring Setup
				//----------------------------------------------------------------------

				//We take the distance vector between the car and the wheel (diff) and project it onto the vertical suspension axis (m_susp_w)
				m_spring_displacement = glm::dot(diff, m_susp_w);

				//Get current relative velocity along suspension axis
				glmvec3 v1 = m_body1->m_linear_velocityW + glm::cross(m_body1->m_angular_velocityW, m_r1);
				glmvec3 v2 = m_body2->m_linear_velocityW + glm::cross(m_body2->m_angular_velocityW, m_r2);
				real vel_susp = glm::dot(v2 - v1, m_susp_w); //speed between truck and wheel along suspension axis

				//Hooke's Law, Damping: F = -kx - cv
				// k = stiffness, x = displacement, c = damping, v = relative velocity
				//-kx: spring
				//-cv: damper
				real force_mag = -(m_suspension_stiffness * m_spring_displacement) - (m_suspension_damping * vel_susp);

				//Converting Force to Impulse
				//Impulse: P = F * dt (Using the actual time step!)
				real impulse_mag = force_mag * dt;			//Impulse magnitude
				glmvec3 impulse = m_susp_w * impulse_mag;	//Impulse = vector along suspension axis * magnitude

				//Apply immediately to velocities (Pre-Solve Step)
				//Body 1: -Impulse
				m_body1->m_linear_velocityW -= m_body1->m_mass_inv * impulse;
				m_body1->m_angular_velocityW -= m_body1->m_inertia_invW * glm::cross(m_r1, impulse);

				//Body 2: +Impulse
				m_body2->m_linear_velocityW += m_body2->m_mass_inv * impulse;
				m_body2->m_angular_velocityW += m_body2->m_inertia_invW * glm::cross(m_r2, impulse);
				...
				glmvec3 target_axle_w = m_axle_w; // Default to normal axle

				if (m_steering_active && m_position == WheelPosition::FRONT) {
					//Rotate the chassis axle around the suspension axis
					//Rodrigues' rotation formula simplified for orthogonal vectors
					//V_rot = V * cos(theta) + (K x V) * sin(theta)
					//K = m_susp_w
					//V = m_axle_w.

					real theta = m_steering_target_angle;
					target_axle_w = glm::normalize(m_axle_w * cos(theta) + glm::cross(m_susp_w, m_axle_w) * sin(theta));
				}

				if (m_motor_active) {
					real speed_projection = glm::dot(m_body2->m_angular_velocityW - m_body1->m_angular_velocityW, m_axle_w); //"spin speed" in radians per second
					m_offset_motor = speed_projection + m_fmotor;
					m_inv_constraint_mass_motor = getMotorAndLimitMass();
				}

				//Hinge Alignment
				//We now force the wheel to align with 'target_axle_w' instead of 'm_axle_w'
				glmvec3 axis2_w_rot = glm::normalize(m_body2->m_model * glmvec4(m_axis_hinge_body2, 0.0_real));
				glmvec3 b1 = geometry::orthoUnitVector(axis2_w_rot);
				glmvec3 c1 = glm::normalize(glm::cross(axis2_w_rot, b1));

				m_offset_rotation = glmvec2(glm::dot(target_axle_w, b1), glm::dot(target_axle_w, c1));
				m_bias_rotation = (m_bias_factor_rot / dt) * m_offset_rotation;

				real max_rot_correction = 10.0_real;
				m_bias_rotation.x = std::clamp(m_bias_rotation.x, -max_rot_correction, max_rot_correction);
				m_bias_rotation.y = std::clamp(m_bias_rotation.y, -max_rot_correction, max_rot_correction);

				m_bCa = glm::cross(b1, target_axle_w); //Use steered axle for Jacobian too
				m_cCa = glm::cross(c1, target_axle_w);

				real a = glm::dot(m_bCa * m_body1->m_inertia_invW, m_bCa) + glm::dot(m_bCa * m_body2->m_inertia_invW, m_bCa);
				real b = glm::dot(m_bCa * m_body1->m_inertia_invW, m_cCa) + glm::dot(m_bCa * m_body2->m_inertia_invW, m_cCa);
				real c = glm::dot(m_cCa * m_body1->m_inertia_invW, m_bCa) + glm::dot(m_cCa * m_body2->m_inertia_invW, m_bCa);
				real d = glm::dot(m_cCa * m_body1->m_inertia_invW, m_cCa) + glm::dot(m_cCa * m_body2->m_inertia_invW, m_cCa);

				glmmat2 rot_mass(a, c, b, d);
				m_inv_constraint_mass_rot = glm::determinant(rot_mass) < Constraint::epsilon ? glmmat2(0.0_real) : glm::inverse(rot_mass);
			}


			///<summary>
			///Solves the velocity constraints for the wheel suspension joint
			///</summary>
			void solveVelocity() override {
				
				//----------------------------------------------------------------------
				//1. Solve Linear Limits (Lock Axle and Perp axes)
				//----------------------------------------------------------------------
				//This constrains the wheel so it can only slide up/down the suspension axis, but not forward/backward or left/right relative to the chassis.
				{
					glmvec3 v1 = m_body1->m_linear_velocityW + glm::cross(m_body1->m_angular_velocityW, m_r1);
					glmvec3 v2 = m_body2->m_linear_velocityW + glm::cross(m_body2->m_angular_velocityW, m_r2);
					glmvec3 dv = v2 - v1;

					//Project relative velocity onto the locked axes
					glmvec2 jv(glm::dot(dv, m_axle_w), glm::dot(dv, m_perp_w));

					//Compute Lambda (impulse magnitude)
					glmvec2 lambda = m_inv_mass_linear * (-jv - m_linear_bias);

					//Axle lock (prevent sliding along the axle)
					glmvec3 P1 = m_axle_w * lambda.x;
					m_body1->m_linear_velocityW -= m_body1->m_mass_inv * P1;
					m_body1->m_angular_velocityW -= m_body1->m_inertia_invW * (glm::cross(m_r1, P1));
					m_body2->m_linear_velocityW += m_body2->m_mass_inv * P1;
					m_body2->m_angular_velocityW += m_body2->m_inertia_invW * (glm::cross(m_r2, P1));

					//Perp lock (prevent sliding forward/backward relative to strut)
					glmvec3 P2 = m_perp_w * lambda.y;
					m_body1->m_linear_velocityW -= m_body1->m_mass_inv * P2;
					m_body1->m_angular_velocityW -= m_body1->m_inertia_invW * (glm::cross(m_r1, P2));
					m_body2->m_linear_velocityW += m_body2->m_mass_inv * P2;
					m_body2->m_angular_velocityW += m_body2->m_inertia_invW * (glm::cross(m_r2, P2));
				}

				//----------------------------------------------------------------------
				//2. Handle Motor Constraint (Drive the wheels)
				//----------------------------------------------------------------------
				//Apply motor torque around the axle
				if (m_motor_active) {
					glmvec3 j_ang1 = m_axle_w;
					glmvec3 j_ang2 = -m_axle_w;

					//Compute relative angular velocity along the axle
					real jv = glm::dot(m_axle_w, -m_body2->m_angular_velocityW + m_body1->m_angular_velocityW);

					//lambda = mass * (-jv - target_speed)
					real lambda = m_inv_constraint_mass_motor * (-jv - m_fmotor);

					//Clamp torque to engine power limits
					lambda = std::clamp(lambda, -m_fmotor_max, m_fmotor_max);

					glmvec3 impulse1 = j_ang1 * lambda;
					glmvec3 impulse2 = j_ang2 * lambda;
				...
				//----------------------------------------------------------------------
				//3. Solve Hinge Rotation Constraint (NOW INCLUDES STEERING)
				//----------------------------------------------------------------------
				//Align the wheel's axle with the chassis' axle (or steered axle)
				glmvec2 abs_offset = glm::abs(m_offset_rotation);
				if (abs_offset.x > Constraint::epsilon || abs_offset.y > Constraint::epsilon) {
