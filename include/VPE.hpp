...
namespace vpe {
	...
	public:
		...
		/// <summary>
		/// This is the template of a Cylinder object for the truck wheels.
		/// I created a cylinder with belnder with the exact same dimensions as the truck wheels.
		...
		inline static Polytope g_Cylinder{
			// Vertices
			{
				{ 0.0_real, 0.940000057220459_real, -0.5199999809265137_real },
				{ 0.0_real, 0.940000057220459_real, 0.5199999809265137_real },
				{ 0.2337685227394104_real, 0.9104682207107544_real, -0.5199999809265137_real },
				{ 0.2337685227394104_real, 0.9104682207107544_real, 0.5199999809265137_real },
				{ 0.45284852385520935_real, 0.8237283229827881_real, -0.5199999809265137_real },
				{ 0.45284852385520935_real, 0.8237283229827881_real, 0.5199999809265137_real },
				{ 0.6434743404388428_real, 0.685230553150177_real, -0.5199999809265137_real },
				{ 0.6434743404388428_real, 0.685230553150177_real, 0.5199999809265137_real },
				{ 0.793668270111084_real, 0.5036773085594177_real, -0.5199999809265137_real },
				{ 0.793668270111084_real, 0.5036773085594177_real, 0.5199999809265137_real },
				{ 0.8939931988716125_real, 0.290475994348526_real, -0.5199999809265137_real },
				{ 0.8939931988716125_real, 0.290475994348526_real, 0.5199999809265137_real },
				{ 0.9381451606750488_real, 0.059023093432188034_real, -0.5199999809265137_real },
				{ 0.9381451606750488_real, 0.059023093432188034_real, 0.5199999809265137_real },
				{ 0.9233500361442566_real, -0.17613844573497772_real, -0.5199999809265137_real },
				{ 0.9233500361442566_real, -0.17613844573497772_real, 0.5199999809265137_real },
				{ 0.8505374789237976_real, -0.40023255348205566_real, -0.5199999809265137_real },
				{ 0.8505374789237976_real, -0.40023255348205566_real, 0.5199999809265137_real },
				{ 0.7242825031280518_real, -0.599178671836853_real, -0.5199999809265137_real },
				{ 0.7242825031280518_real, -0.599178671836853_real, 0.5199999809265137_real },
				{ 0.5525181889533997_real, -0.7604760527610779_real, -0.5199999809265137_real },
				{ 0.5525181889533997_real, -0.7604760527610779_real, 0.5199999809265137_real },
				{ 0.3460370898246765_real, -0.8739899396896362_real, -0.5199999809265137_real },
				{ 0.3460370898246765_real, -0.8739899396896362_real, 0.5199999809265137_real },
				{ 0.11781324446201324_real, -0.9325879216194153_real, -0.5199999809265137_real },
				{ 0.11781324446201324_real, -0.9325879216194153_real, 0.5199999809265137_real },
				{ -0.11781324446201324_real, -0.9325879216194153_real, -0.5199999809265137_real },
				{ -0.11781324446201324_real, -0.9325879216194153_real, 0.5199999809265137_real },
				{ -0.3460370898246765_real, -0.8739899396896362_real, -0.5199999809265137_real },
			...
			// Edges
			{ { 0, 1 }, { 0, 3 }, { 0, 2 }, { 1, 3 }, { 1, 2 }, { 2, 3 }, { 2, 5 }, { 2, 4 }, { 3, 5 }, { 3, 4 }, { 4, 5 }, { 4, 7 }, { 4, 6 }, { 5, 7 }, { 5, 6 }, { 6, 7 }, { 6, 9 }, { 6, 8 }, { 7, 9 }, { 7, 8 }, { 8, 9 }, { 8, 11 }, { 8, 10 }, { 9, 11 }, { 9, 10 }, { 10, 11 }, { 10, 13 }, { 10, 12 }, { 11, 13 }, { 11, 12 }, { 12, 13 }, { 12, 15 }, { 12, 14 }, { 13, 15 }, { 13, 14 }, { 14, 15 }, { 14, 17 }, { 14, 16 }, { 15, 17 }, { 15, 16 }, { 16, 17 }, { 16, 19 }, { 16, 18 }, { 17, 19 }, { 17, 18 }, { 18, 19 }, { 18, 21 }, { 18, 20 }, { 19, 21 }, { 19, 20 }, { 20, 21 }, { 20, 23 }, { 20, 22 }, { 21, 23 }, { 21, 22 }, { 22, 23 }, { 22, 25 }, { 22, 24 }, { 23, 25 }, { 23, 24 }, { 24, 25 }, { 24, 27 }, { 24, 26 }, { 25, 27 }, { 25, 26 }, { 26, 27 }, { 26, 29 }, { 26, 28 }, { 27, 29 }, { 27, 28 }, { 28, 29 }, { 28, 31 }, { 28, 30 }, { 29, 31 }, { 29, 30 }, { 30, 31 }, { 30, 33 }, { 30, 32 }, { 31, 33 }, { 31, 32 }, { 32, 33 }, { 32, 35 }, { 32, 34 }, { 33, 35 }, { 33, 34 }, { 34, 35 }, { 34, 37 }, { 34, 36 }, { 35, 37 }, { 35, 36 }, { 36, 37 }, { 36, 39 }, { 36, 38 }, { 37, 39 }, { 37, 38 }, { 38, 39 }, { 38, 41 }, { 38, 40 }, { 39, 41 }, { 39, 40 }, { 40, 41 }, { 40, 43 }, { 40, 42 }, { 41, 43 }, { 41, 42 }, { 42, 43 }, { 42, 45 }, { 42, 44 }, { 43, 45 }, { 43, 44 }, { 44, 45 }, { 44, 47 }, { 44, 46 }, { 45, 47 }, { 45, 46 }, { 46, 47 }, { 3, 49 }, { 3, 47 }, { 3, 45 }, { 3, 43 }, { 3, 41 }, { 3, 39 }, { 3, 37 }, { 3, 35 }, { 3, 33 }, { 3, 31 }, { 3, 29 }, { 3, 27 }, { 3, 25 }, { 3, 23 }, { 3, 21 }, { 3, 19 }, { 3, 17 }, { 3, 15 }, { 3, 13 }, { 3, 11 }, { 3, 9 }, { 3, 7 }, { 1, 49 }, { 1, 47 }, { 1, 45 }, { 1, 43 }, { 1, 41 }, { 1, 39 }, { 1, 37 }, { 1, 35 }, { 1, 33 }, { 1, 31 }, { 1, 29 }, { 1, 27 }, { 1, 25 }, { 1, 23 }, { 1, 21 }, { 1, 19 }, { 1, 17 }, { 1, 15 }, { 1, 13 }, { 1, 11 }, { 1, 9 }, { 1, 7 }, { 1, 5 }, { 47, 49 }, { 45, 49 }, { 43, 49 }, { 41, 49 }, { 39, 49 }, { 37, 49 }, { 35, 49 }, { 33, 49 }, { 31, 49 }, { 29, 49 }, { 27, 49 }, { 25, 49 }, { 23, 49 }, { 21, 49 }, { 19, 49 }, { 17, 49 }, { 15, 49 }, { 13, 49 }, { 11, 49 }, { 9, 49 }, { 7, 49 }, { 5, 49 }, { 43, 47 }, { 41, 47 }, { 39, 47 }, { 37, 47 }, { 35, 47 }, { 33, 47 }, { 31, 47 }, { 29, 47 }, { 27, 47 }, { 25, 47 }, { 23, 47 }, { 21, 47 }, { 19, 47 }, { 17, 47 }, { 15, 47 }, { 13, 47 }, { 11, 47 }, { 9, 47 }, { 7, 47 }, { 5, 47 }, { 41, 45 }, { 39, 45 }, { 37, 45 }, { 35, 45 }, { 33, 45 }, { 31, 45 }, { 29, 45 }, { 27, 45 }, { 25, 45 }, { 23, 45 }, { 21, 45 }, { 19, 45 }, { 17, 45 }, { 15, 45 }, { 13, 45 }, { 11, 45 }, { 9, 45 }, { 7, 45 }, { 5, 45 }, { 39, 43 }, { 37, 43 }, { 35, 43 }, { 33, 43 }, { 31, 43 }, { 29, 43 }, { 27, 43 }, { 25, 43 }, { 23, 43 }, { 21, 43 }, { 19, 43 }, { 17, 43 }, { 15, 43 }, { 13, 43 }, { 11, 43 }, { 9, 43 }, { 7, 43 }, { 5, 43 }, { 37, 41 }, { 35, 41 }, { 33, 41 }, { 31, 41 }, { 29, 41 }, { 27, 41 }, { 25, 41 }, { 23, 41 }, { 21, 41 }, { 19, 41 }, { 17, 41 }, { 15, 41 }, { 13, 41 }, { 11, 41 }, { 9, 41 }, { 7, 41 }, { 5, 41 }, { 35, 39 }, { 33, 39 }, { 31, 39 }, { 29, 39 }, { 27, 39 }, { 25, 39 }, { 23, 39 }, { 21, 39 }, { 19, 39 }, { 17, 39 }, { 15, 39 }, { 13, 39 }, { 11, 39 }, { 9, 39 }, { 7, 39 }, { 5, 39 }, { 33, 37 }, { 31, 37 }, { 29, 37 }, { 27, 37 }, { 25, 37 }, { 23, 37 }, { 21, 37 }, { 19, 37 }, { 17, 37 }, { 15, 37 }, { 13, 37 }, { 11, 37 }, { 9, 37 }, { 7, 37 }, { 5, 37 }, { 31, 35 }, { 29, 35 }, { 27, 35 }, { 25, 35 }, { 23, 35 }, { 21, 35 }, { 19, 35 }, { 17, 35 }, { 15, 35 }, { 13, 35 }, { 11, 35 }, { 9, 35 }, { 7, 35 }, { 5, 35 }, { 29, 33 }, { 27, 33 }, { 25, 33 }, { 23, 33 }, { 21, 33 }, { 19, 33 }, { 17, 33 }, { 15, 33 }, { 13, 33 }, { 11, 33 }, { 9, 33 }, { 7, 33 }, { 5, 33 }, { 27, 31 }, { 25, 31 }, { 23, 31 }, { 21, 31 }, { 19, 31 }, { 17, 31 }, { 15, 31 }, { 13, 31 }, { 11, 31 }, { 9, 31 }, { 7, 31 }, { 5, 31 }, { 25, 29 }, { 23, 29 }, { 21, 29 }, { 19, 29 }, { 17, 29 }, { 15, 29 }, { 13, 29 }, { 11, 29 }, { 9, 29 }, { 7, 29 }, { 5, 29 }, { 23, 27 }, { 21, 27 }, { 19, 27 }, { 17, 27 }, { 15, 27 }, { 13, 27 }, { 11, 27 }, { 9, 27 }, { 7, 27 }, { 5, 27 }, { 21, 25 }, { 19, 25 }, { 17, 25 }, { 15, 25 }, { 13, 25 }, { 11, 25 }, { 9, 25 }, { 7, 25 }, { 5, 25 }, { 19, 23 }, { 17, 23 }, { 15, 23 }, { 13, 23 }, { 11, 23 }, { 9, 23 }, { 7, 23 }, { 5, 23 }, { 17, 21 }, { 15, 21 }, { 13, 21 }, { 11, 21 }, { 9, 21 }, { 7, 21 }, { 5, 21 }, { 15, 19 }, { 13, 19 }, { 11, 19 }, { 9, 19 }, { 7, 19 }, { 5, 19 }, { 13, 17 }, { 11, 17 }, { 9, 17 }, { 7, 17 }, { 5, 17 }, { 11, 15 }, { 9, 15 }, { 7, 15 }, { 5, 15 }, { 9, 13 }, { 7, 13 }, { 5, 13 }, { 7, 11 }, { 5, 11 }, { 5, 9 }, { 46, 49 }, { 46, 48 }, { 47, 48 }, { 48, 49 }, { 1, 48 }, { 0, 48 }, { 0, 49 }, { 0, 4 }, { 0, 6 }, { 0, 8 }, { 0, 10 }, { 0, 12 }, { 0, 14 }, { 0, 16 }, { 0, 18 }, { 0, 20 }, { 0, 22 }, { 0, 24 }, { 0, 26 }, { 0, 28 }, { 0, 30 }, { 0, 32 }, { 0, 34 }, { 0, 36 }, { 0, 38 }, { 0, 40 }, { 0, 42 }, { 0, 44 }, { 0, 46 }, { 2, 6 }, { 2, 8 }, { 2, 10 }, { 2, 12 }, { 2, 14 }, { 2, 16 }, { 2, 18 }, { 2, 20 }, { 2, 22 }, { 2, 24 }, { 2, 26 }, { 2, 28 }, { 2, 30 }, { 2, 32 }, { 2, 34 }, { 2, 36 }, { 2, 38 }, { 2, 40 }, { 2, 42 }, { 2, 44 }, { 2, 46 }, { 2, 48 }, { 4, 8 }, { 4, 10 }, { 4, 12 }, { 4, 14 }, { 4, 16 }, { 4, 18 }, { 4, 20 }, { 4, 22 }, { 4, 24 }, { 4, 26 }, { 4, 28 }, { 4, 30 }, { 4, 32 }, { 4, 34 }, { 4, 36 }, { 4, 38 }, { 4, 40 }, { 4, 42 }, { 4, 44 }, { 4, 46 }, { 4, 48 }, { 6, 10 }, { 6, 12 }, { 6, 14 }, { 6, 16 }, { 6, 18 }, { 6, 20 }, { 6, 22 }, { 6, 24 }, { 6, 26 }, { 6, 28 }, { 6, 30 }, { 6, 32 }, { 6, 34 }, { 6, 36 }, { 6, 38 }, { 6, 40 }, { 6, 42 }, { 6, 44 }, { 6, 46 }, { 6, 48 }, { 8, 12 }, { 8, 14 }, { 8, 16 }, { 8, 18 }, { 8, 20 }, { 8, 22 }, { 8, 24 }, { 8, 26 }, { 8, 28 }, { 8, 30 }, { 8, 32 }, { 8, 34 }, { 8, 36 }, { 8, 38 }, { 8, 40 }, { 8, 42 }, { 8, 44 }, { 8, 46 }, { 8, 48 }, { 10, 14 }, { 10, 16 }, { 10, 18 }, { 10, 20 }, { 10, 22 }, { 10, 24 }, { 10, 26 }, { 10, 28 }, { 10, 30 }, { 10, 32 }, { 10, 34 }, { 10, 36 }, { 10, 38 }, { 10, 40 }, { 10, 42 }, { 10, 44 }, { 10, 46 }, { 10, 48 }, { 12, 16 }, { 12, 18 }, { 12, 20 }, { 12, 22 }, { 12, 24 }, { 12, 26 }, { 12, 28 }, { 12, 30 }, { 12, 32 }, { 12, 34 }, { 12, 36 }, { 12, 38 }, { 12, 40 }, { 12, 42 }, { 12, 44 }, { 12, 46 }, { 12, 48 }, { 14, 18 }, { 14, 20 }, { 14, 22 }, { 14, 24 }, { 14, 26 }, { 14, 28 }, { 14, 30 }, { 14, 32 }, { 14, 34 }, { 14, 36 }, { 14, 38 }, { 14, 40 }, { 14, 42 }, { 14, 44 }, { 14, 46 }, { 14, 48 }, { 16, 20 }, { 16, 22 }, { 16, 24 }, { 16, 26 }, { 16, 28 }, { 16, 30 }, { 16, 32 }, { 16, 34 }, { 16, 36 }, { 16, 38 }, { 16, 40 }, { 16, 42 }, { 16, 44 }, { 16, 46 }, { 16, 48 }, { 18, 22 }, { 18, 24 }, { 18, 26 }, { 18, 28 }, { 18, 30 }, { 18, 32 }, { 18, 34 }, { 18, 36 }, { 18, 38 }, { 18, 40 }, { 18, 42 }, { 18, 44 }, { 18, 46 }, { 18, 48 }, { 20, 24 }, { 20, 26 }, { 20, 28 }, { 20, 30 }, { 20, 32 }, { 20, 34 }, { 20, 36 }, { 20, 38 }, { 20, 40 }, { 20, 42 }, { 20, 44 }, { 20, 46 }, { 20, 48 }, { 22, 26 }, { 22, 28 }, { 22, 30 }, { 22, 32 }, { 22, 34 }, { 22, 36 }, { 22, 38 }, { 22, 40 }, { 22, 42 }, { 22, 44 }, { 22, 46 }, { 22, 48 }, { 24, 28 }, { 24, 30 }, { 24, 32 }, { 24, 34 }, { 24, 36 }, { 24, 38 }, { 24, 40 }, { 24, 42 }, { 24, 44 }, { 24, 46 }, { 24, 48 }, { 26, 30 }, { 26, 32 }, { 26, 34 }, { 26, 36 }, { 26, 38 }, { 26, 40 }, { 26, 42 }, { 26, 44 }, { 26, 46 }, { 26, 48 }, { 28, 32 }, { 28, 34 }, { 28, 36 }, { 28, 38 }, { 28, 40 }, { 28, 42 }, { 28, 44 }, { 28, 46 }, { 28, 48 }, { 30, 34 }, { 30, 36 }, { 30, 38 }, { 30, 40 }, { 30, 42 }, { 30, 44 }, { 30, 46 }, { 30, 48 }, { 32, 36 }, { 32, 38 }, { 32, 40 }, { 32, 42 }, { 32, 44 }, { 32, 46 }, { 32, 48 }, { 34, 38 }, { 34, 40 }, { 34, 42 }, { 34, 44 }, { 34, 46 }, { 34, 48 }, { 36, 40 }, { 36, 42 }, { 36, 44 }, { 36, 46 }, { 36, 48 }, { 38, 42 }, { 38, 44 }, { 38, 46 }, { 38, 48 }, { 40, 44 }, { 40, 46 }, { 40, 48 }, { 42, 46 }, { 42, 48 }, { 44, 48 }, },
			// Faces
			{
				{{ 0, 1 }, { 1, 1 }, { 3, 1 }, { 2, 1 }},
				{{ 2, 1 }, { 3, 1 }, { 5, 1 }, { 4, 1 }},
				...
				{{ 42, 1 }, { 43, 1 }, { 45, 1 }, { 44, 1 }},
				{{ 44, 1 }, { 45, 1 }, { 47, 1 }, { 46, 1 }},
				{{ 3, 1 }, { 1, 1 }, { 49, 1 }, { 47, 1 }, { 45, 1 }, { 43, 1 }, { 41, 1 }, { 39, 1 }, { 37, 1 }, { 35, 1 }, { 33, 1 }, { 31, 1 }, { 29, 1 }, { 27, 1 }, { 25, 1 }, { 23, 1 }, { 21, 1 }, { 19, 1 }, { 17, 1 }, { 15, 1 }, { 13, 1 }, { 11, 1 }, { 9, 1 }, { 7, 1 }, { 5, 1 }},
				{{ 46, 1 }, { 47, 1 }, { 49, 1 }, { 48, 1 }},
				{{ 48, 1 }, { 49, 1 }, { 1, 1 }, { 0, 1 }},
				{{ 0, 1 }, { 2, 1 }, { 4, 1 }, { 6, 1 }, { 8, 1 }, { 10, 1 }, { 12, 1 }, { 14, 1 }, { 16, 1 }, { 18, 1 }, { 20, 1 }, { 22, 1 }, { 24, 1 }, { 26, 1 }, { 28, 1 }, { 30, 1 }, { 32, 1 }, { 34, 1 }, { 36, 1 }, { 38, 1 }, { 40, 1 }, { 42, 1 }, { 44, 1 }, { 46, 1 }, { 48, 1 }},
			},
			// Inertia tensor calculation (callback)
			[](real mass, glmvec3& s) {
				return mass * glmmat3{ {s.y * s.y + s.z * s.z, 0, 0}, {0, s.x * s.x + s.z * s.z, 0}, {0, 0, s.x * s.x + s.y * s.y} } / 12.0_real;
			}
		};
		...
		/// <summary>
		/// This is the template of a cuboid object for the truck body. 
		/// I created a cube with belnder with the exact same dimensions as the truck body.
		/// It contains the basic geometric properties:
		/// Vertices, edges, and faces. We use a left-handed coordinate system. 
		/// Edges can have signs, meaning their vectors are multiplied with this factor (1 or -1).
		/// </summary>
		inline static Polytope g_truck_cuboid{
			// Vertices
			{
				{ -1.0_real, -1.0_real, -1.0_real },
				{ -1.0_real, -1.0_real, 1.0_real },
				{ -1.0_real, 1.0_real, -1.0_real },
				{ -1.0_real, 1.0_real, 1.0_real },
				{ 1.0_real, -1.0_real, -1.0_real },
			...
			// Edges
			{ { 0, 1 }, { 0, 3 }, { 0, 2 }, { 1, 3 }, { 1, 2 }, { 2, 3 }, { 2, 7 }, { 2, 6 }, { 3, 7 }, { 3, 6 }, { 6, 7 }, { 5, 6 }, { 4, 6 }, { 5, 7 }, { 4, 7 }, { 4, 5 }, { 1, 4 }, { 0, 4 }, { 1, 5 }, { 0, 5 }, { 2, 4 }, { 0, 6 }, { 1, 7 }, { 3, 5 }, },
			// Faces
			{
				{{ 0, 1 }, { 1, 1 }, { 3, 1 }, { 2, 1 }},
				{{ 2, 1 }, { 3, 1 }, { 7, 1 }, { 6, 1 }},
