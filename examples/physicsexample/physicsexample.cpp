...
namespace ve {
	...
	public:
		...
		VEEventListenerConstraintsGUI(std::string name, VPEWorld* phy) : VEEventListener{ name }, m_physics{ phy }, m_constraintDemos{ phy, onMove, onErase }, m_trialBike{ phy, onMove, onErase } {};
